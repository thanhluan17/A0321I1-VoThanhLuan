...
//            BAI TAP 1
            CallableStatement callableStatement = BaseRepository.getConnection().prepareCall("call get_all_user()");
...
//            preparedStatement.executeUpdate();
//            BAI TAP 1
            CallableStatement callableStatement = BaseRepository.getConnection().prepareCall("call edit_user_info(?, ?, ?, ?);");
...
//            BAI TAP 1
    ...
    public void addUserTransaction(User user, int[] permisions) {
        ...
        try {
            ...
            //pstmt.setInt(1, user.getName()); // BAI TAP 2
