        ...
        <div class="col-lg-12">
            ...
            <form action="/employee?action=create" method="post">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="name" name="name" value="${createEmployee.name}"
                           required>
                </div>
                <div class="form-group">
                    <label for="birthday">Birthday</label>
                    <input type="date" class="form-control" id="birthday" name="birthday"
                           value="${createEmployee.birthday}" required>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="idCard" name="idCard" value="${createEmployee.idCard}"
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" id="salary" name="salary" value="${createEmployee.salary}"
                           required>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="phone" name="phone" value="${createEmployee.phone}"
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="email" name="email" value="${createEmployee.email}"
                           required>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="address" name="address"
                           value="${createEmployee.address}" required>
                </div>
                <div class="form-group">
                    ...
                    <select class="form-control" id="position" name="position" required>
                        <c:forEach var="position" items="${positionList}">
                            <c:choose>
                                <c:when test="${position.id == createEmployee.positionId}">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" id="education" name="education" required>
                        <c:forEach var="education" items="${educationList}">
                            <c:choose>
                                <c:when test="${education.id == createEmployee.educationId}">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" id="division" name="division" required>
                        <c:forEach var="division" items="${divisionList}">
                            <c:choose>
                                <c:when test="${division.id == createEmployee.divisionId}">
