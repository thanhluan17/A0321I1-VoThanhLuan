...
public class Employee {
    ...
    public Employee(int id, String name, String birthday, String idCard, double salary, String phone, String email, String address, int positionId, int educationId, int divisionId) {
        this.id = id;
        this.name = name;
